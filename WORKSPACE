...
http_archive(
	name = "com_github_bazelboost_circular_buffer",
	strip_prefix = "circular_buffer-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/circular_buffer/archive/boost-1.65.1.tar.gz"
	],
)
